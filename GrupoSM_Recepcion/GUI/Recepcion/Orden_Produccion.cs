...
namespace GrupoSM_Recepcion.GUI.Recepcion
{
    public partial class Orden_Produccion : Form
    {
        ...
        {                             
            ...
            agregartallasgui.label_consumotela.Text = textBox2.Text;
            agregartallasgui.lbl_consumocombinacion.Text = lbl_consumocombinacion.Text;        
            agregartallasgui.lbl_consumoforro.Text = lbl_consumoforro.Text;

            agregartallasgui.lbl_anchocombinacion.Text = lbl_anchocombinacion.Text;
            agregartallasgui.lbl_anchotela.Text = lbl_anchotela.Text;
            agregartallasgui.lbl_anchoforro.Text = lbl_anchoforro.Text;

            agregartallasgui.lbl_combinacion.Text = lbl_combinacion.Text;
            agregartallasgui.lbl_tela.Text = lbl_tela.Text;
            agregartallasgui.lbl_forro.Text = lbl_forro.Text;
