    ...
    public partial class Telas_corte : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                telasdao.largo_trazo = decimal.Parse(textBox4.Text);
                telasdao.paños = decimal.Parse(textBox5.Text);
                telasdao.utilizado_tela = decimal.Parse(textBox6.Text);
                telasdao.retazo_tela = decimal.Parse(textBox8.Text);
                telasdao.saldo_tela = decimal.Parse(textBox7.Text);
                //telasdao.ancho = decimal.Parse(textBox9.Text);
                telasdao.faltante_tela = decimal.Parse(textBox10.Text);
