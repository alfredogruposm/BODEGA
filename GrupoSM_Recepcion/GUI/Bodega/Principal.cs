...
namespace GrupoSM_Recepcion.GUI.Bodega
{
    public partial class Principal : Form
    {
        ...
        {
            GUI.Bodega.SeleccionarOrdenTela telasgui = new SeleccionarOrdenTela();
            telasgui.ShowDialog();
        ...
        private void Principal_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.DataSource = ordendao.devuelvebitacoratabla();
        ...
        {
            GUI.Bodega.GrupoSM grupoSM = new GrupoSM();
            grupoSM.Show();
        }
